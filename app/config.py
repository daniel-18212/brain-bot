...
class Settings:
    def __init__(self):
        ...
        self.GITHUB_TOKEN: str = os.getenv("GITHUB_TOKEN", "").strip()  # GitHub Models (GPT-4o Free)
        self.OPENAI_API_KEY: str = os.getenv("OPENAI_API_KEY", "").strip()  # Opcional
    ...
    def validate(self) -> None:
        ...
        if not has_any_key:
            raise ValueError(
                ...
                "Configure ao menos uma chave no .env (DEEPSEEK_API_KEY, GEMINI_API_KEY, GROQ_API_KEY ou GITHUB_TOKEN)."
            )
